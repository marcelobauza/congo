...
class ProjectTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_type" do
    assert_difference('ProjectType.count') do
      post project_types_url, params: { project_type: { color: @project_type.color, is_active: @project_type.is_active, name: @project_type.name } }
    end
  ...
  test "should update project_type" do
    patch project_type_url(@project_type), params: { project_type: { color: @project_type.color, is_active: @project_type.is_active, name: @project_type.name } }
