...
class PoisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poi" do
    assert_difference('Poi.count') do
      post pois_url, params: { poi: { name: @poi.name, poi_subcategory_id: @poi.poi_subcategory_id, the_geom: @poi.the_geom } }
    end
  ...
  test "should update poi" do
    patch poi_url(@poi), params: { poi: { name: @poi.name, poi_subcategory_id: @poi.poi_subcategory_id, the_geom: @poi.the_geom } }
