class BotsController < ApplicationController
  ...
  private
    ...
    def bot_params
      params.require(:bot).permit(:publish, :code, :type, :modality, :properties, :region, :comune, :street, :number, :furnished, :apt, :floor, :bedroom, :bathroom, :parkink_lo, :cellar, :surface, :surface_t, :price, :price_uf, :price_usd, :owner, :phone, :email, :bimester, :the_geom)
    end
end
