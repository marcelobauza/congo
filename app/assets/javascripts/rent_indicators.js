  ...
  indicators = function(nId) {
    ...
    $.ajax({
      ...
      beforeSend: function() {
        ...
        // TODO: los conetenedores se eliminan cuando se ejecuta la función nuevamente
        // pero ahora se ejecuta cuando hacemos click en el polígono y no cuando cambia
        // la capa. Hay que eliminar los contenedores en otro lado
